...
//Attributes that specifies that a virtual camera component must be present in GameObject / Behaviour
[RequireComponent(typeof(ICinemachineCamera))]
//Allows a virtual camera to take control for given seconds
